...
class Rule(db.Model):
    ...
    # Foreign key yang merujuk ke 'nama_tabel.nama_kolom'
    ...
    # Relasi many-to-one: Banyak aturan merujuk ke satu penyakit
    # 'back_populates' harus cocok dengan nama relasi di model Penyakit
    penyakit = db.relationship("Penyakit", back_populates="rules")
    
    # Relasi many-to-one: Banyak aturan merujuk ke satu gejala
    # 'back_populates' harus cocok dengan nama relasi di model Gejala
