...
const Card = ({ title, body, children }) => {
	return (
		<div className="bg-background p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 border border-gray-100 h-full flex flex-col">
			...
			<p className="text-gray-600 text-sm leading-relaxed text-center grow">{body}</p>
		</div>
	);
};
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
							...
							<Card title={"Apa itu PMS?"}>
								...
								<p className="text-gray-600 text-sm leading-relaxed">
									PMS disebabkan oleh bakteri, virus, atau parasit. Penularan utamanya terjadi
									melalui kontak seksual (vaginal, anal, atau oral), namun beberapa juga dapat
									menular melalui darah atau dari ibu ke anak selama kehamilan.
								</p>
							</Card>
							...
							<Card title={"Gejala Umum"}>
								...
								<p className="text-gray-600 text-sm leading-relaxed">
									Waspadai tanda-tanda seperti rasa nyeri saat buang air kecil, keluarnya cairan
									tidak normal (nanah/keputihan berbau), munculnya luka atau kutil di area genital,
									serta rasa gatal atau panas yang tidak wajar.
								</p>
							</Card>
							...
							<Card title={"Bahaya & Resiko"}>
								...
								<p className="text-gray-600 text-sm leading-relaxed">
									...
									kerusakan organ reproduksi, kemandulan (infertilitas), kehamilan di luar
									kandungan, hingga meningkatkan risiko terkena HIV/AIDS.
								</p>
							</Card>
						</div>
					</div>
