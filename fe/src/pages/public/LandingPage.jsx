...
const LandingPage = () => {
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <section
                className="relative bg-gradient-to-br from-primary via-[#1a7a9a] to-secondary text-white py-20 overflow-hidden">
                {/* Background Wave */}
                ...
                <div className="container mx-auto px-4 flex flex-col md:flex-row items-center relative z-10">
                    <div className="md:w-1/2 mb-8 md:mb-0">
                        ...
                        <p className="text-lg md:text-xl mb-6 leading-relaxed opacity-90">
                            Sistem pakar kesehatan menggunakan metode <strong>Forward Chaining</strong> dan <strong>Certainty
                            Factor</strong>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold text-center mb-12 text-primary">Cara Kerja Sistem</h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-background p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                            <div className="flex items-center mb-4">
                                <div
                                    className="bg-primary text-white rounded-full w-12 h-12 flex items-center justify-center mr-4">
