...
export default function Header() {
  ...
  return (
    <>
      <header
        className={`border-b-\[1px] sticky top-0 z-50 flex h-16 w-full items-center justify-around border-red-900 bg-white p-3 text-black backdrop-blur-sm transition-colors duration-300 sm:p-4 lg:p-5`}
      >
        ...
        <div className="ml-10 flex w-3xs justify-center">
          <div className="h-9 w-20">
            <Button color="" text={'Masuk'} onClick={() => navigate({ pathname: '/login' })} />
          </div>
        </div>
      </header>
    </>
