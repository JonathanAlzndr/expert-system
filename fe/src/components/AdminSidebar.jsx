				...
				<ul className="space-y-2">
					<li>
						<Link
							...
							className={`w-full text-left px-4 py-3 rounded-lg flex items-center ${
								location.pathname === "/admin" ? "bg-primary" : "hover:bg-gray-700"
							}`}
						>
					...
					<li>
						<Link
							to="/admin/diseases"
							className={`w-full text-left px-4 py-3 rounded-lg flex items-center ${
								location.pathname === "/admin/diseases" ? "bg-primary" : "hover:bg-gray-700"
							}`}
						>
					...
					<li>
						<Link
							to="/admin/symptoms"
							className={`w-full text-left px-4 py-3 rounded-lg flex items-center ${
								location.pathname === "/admin/symptoms" ? "bg-primary" : "hover:bg-gray-700"
							}`}
						>
					...
					<li>
						<Link
							to="/admin/rules"
							className={`w-full text-left px-4 py-3 rounded-lg flex items-center ${
								location.pathname === "/admin/rules" ? "bg-primary" : "hover:bg-gray-700"
							}`}
						>
